...
public class SerializedFileBasedEmployeeFactory extends FileGroupsFactory {
    public SerializedFileBasedEmployeeFactory(String path) {
        super(new GroupsManagerTextFileSource(), path);
    }

    @Override
    void changePath(String newPath) {
        source = new GroupsManagerTextFileSource();
